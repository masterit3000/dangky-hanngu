...
To build the final jar and optimize the dangkythitienghan application for production, run:
...
Then navigate to [http://localhost:10100](http://localhost:10100) in your browser.
