package com.dangky.hanngu.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.dangky.hanngu.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dangky.hanngu.repository.UserRepository.USERS_BY_EMAIL_CACHE);
